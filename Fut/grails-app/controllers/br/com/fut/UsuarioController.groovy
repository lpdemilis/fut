...
class UsuarioController {
    ...
    def save() {
		...
		usuarioInstance.username = usuarioInstance.email
		usuarioInstance.dataCadastro = new Date()
		
		def enderecoInstance = new Endereco(params)
		
		usuarioInstance.endereco = enderecoInstance
    ...
    def update(Long id, Long version) {
		...
		def enderecoInstance = usuarioInstance.endereco

		if(usuarioInstance.endereco?.id){
