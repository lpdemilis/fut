	...
	<body>
		...
		<div id="show-pais" class="content scaffold-show" role="main">
			...
			<ol class="property-list pais">
				...
				<g:if test="${paisInstance?.name}">
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="pais.name.label" default="Name" /></span>
					
						<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${paisInstance}" field="name"/></span>
