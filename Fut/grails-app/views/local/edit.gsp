...
<html>
	...
	<body>
		<a href="#edit-local" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-local" class="content scaffold-edit" role="main">
